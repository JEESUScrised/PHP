...
### Если MySQL не работает или есть проблемы с подключением

**Полная переустановка MySQL (удалит все данные!):**
...
sudo bash reinstall-mysql.sh
```

Этот скрипт:
- Полностью удалит MySQL и все данные
- Установит MySQL заново
- Настроит пароль root: `123qweasd`
- Настроит правильную аутентификацию

**ВНИМАНИЕ: Все данные в MySQL будут удалены!**
...
- Отключит дефолтный сайт
- Создаст конфигурацию eshop (если нужно)
- Активирует сайт eshop
- Включит необходимые модули
- Перезапустит Apache
- Покажет диагностику
